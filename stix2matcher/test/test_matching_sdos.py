...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("[person:name='alice']", "observed-data--a49751b8-b041-4c00-96c2-76af472bfbbe"),
        (
        ...
        ("[person:name='carol'] OR [person:name>'zelda']", "observed-data--52a5bab7-2cfd-40c6-a35a-b5bcb8afb11b"),
    ],
)
