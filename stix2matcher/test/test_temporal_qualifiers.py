...
_observations = [
    {
        ...
        "number_observed": 1,
        "objects": {"0": {"type": u"person", "name": u"alice"}},
    },
    {
        "type": "observed-data",
        ...
        "number_observed": 1,
        "objects": {"0": {"type": u"person", "name": u"bob"}},
    },
    {
        "type": "observed-data",
        ...
        "number_observed": 1,
        "objects": {"0": {"type": u"person", "name": u"carol"}},
    },
]
...
@pytest.mark.parametrize(
    "min1,max1,min2,max2,expected_overlap",
    [
...
def test_within_match(interval1, interval2, duration):
    ...
    pattern = "([person:name='alice'] AND [person:name='bob']) " "WITHIN {0} SECONDS".format(duration)
    assert match(pattern, _observations)


@pytest.mark.parametrize(
    "interval1,interval2,duration", [((_1, _2), (_4, _5), 1), ((_1, _1), (_4, _5), 2), ((_1, _2), (_5, _5), 2),]
)
