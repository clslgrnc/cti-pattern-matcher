...
_observations = [
    {
        ...
        "number_observed": 2,
        "objects": {"a0": {"type": u"person", "name": u"alice", "age": 10}},
    },
    {
        "type": "observed-data",
        ...
        "number_observed": 3,
        "objects": {"b0": {"type": u"person", "name": u"bob", "age": 17}},
    },
    {
        "type": "observed-data",
        ...
        "number_observed": 2,
        "objects": {"c0": {"type": u"person", "name": u"carol", "age": 22}},
    },
]
...
@pytest.mark.parametrize(
    "pattern", ["[person:age < 20] REPEATS 10 TIMES", "[person:age < 20] REPEATS 2 TIMES REPEATS 3 TIMES"]
)
...
@pytest.mark.parametrize("pattern", ["[person:age < 20] REPEATS 10 TIMES WITHIN 8 SECONDS",])
